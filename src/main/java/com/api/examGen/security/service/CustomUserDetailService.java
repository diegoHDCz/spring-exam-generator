package com.api.examGen.security.service;

import com.api.examGen.persistence.model.ApplicationUser;
import com.api.examGen.persistence.repository.ApplicationUserRepository;
...
public class CustomUserDetailService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ApplicationUser applicationUser = loadingApplicationUserByUsername(username);
        return new CustomUserDetails(applicationUser);
    }

    public ApplicationUser loadingApplicationUserByUsername(String username) {
